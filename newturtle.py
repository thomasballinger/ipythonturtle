"""Logging functionality like this should be grafted on to normal turtle methods,
so that turtles still know their internal state at all times."""
import uuid
import json
...
class Render(object):
    ...
    #def __repr__(self):
    #    return 'Render Instructions:\n'+repr(self.already_run) + repr(self.to_run)
